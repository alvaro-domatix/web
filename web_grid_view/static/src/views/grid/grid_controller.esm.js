...
export class GridController extends Component {
    ...
    static components = {Layout, GridRenderer};
    static props = {
        ...standardViewProps,
    ...
    get periodLabel() {
        if (!this.model.activeRange) return "";
        ...
        if (span === "month") return start.toFormat("MMMM yyyy");
        if (span === "year") return start.toFormat("yyyy");
